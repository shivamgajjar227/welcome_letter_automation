...
from . import dynamic_disctionary
...
def create_and_load_config_file():
    ...
    if not os.path.isfile(config_file_path):
        ...
        return dynamic_disctionary.config_initial(config_file_path)
...
def create_logger(logger_name, handler_type, logging_level="DEBUG", host=constants.CONST_DEFAULT_HOST_IP,
    ...
    for handler_item in handler_type:
        ...
        if result:
            ...
            dynamic_disctionary.update_config_dictionary(logger_name, base_path, config_file_path, handler_item,
...
def get_mapping_list():
    ...
    if not os.path.isfile(mapping_list_path):
        ...
        if previous_config_read:
            ...
            dynamic_disctionary.config_initial(config_file_path)
