            ...
            if current_company and current_company.lower() == company_name.lower():
                ...
                try:
                    ...
                    if not quickcap_page.is_edit_button_available():
                        ...
                        selected_suffix = constants.SUFFIX_MAP.get(category.strip(), "") if category else ""
                        quickcap_page.select_suffix_dropdown1(selected_suffix)
                ...
                selected_suffix = constants.SUFFIX_MAP.get(category.strip(), "") if category else ""
                quickcap_page.select_suffix_dropdown(selected_suffix)
                gender_map = {
